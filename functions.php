<?php
/**
 * xtrac-three functions and definitions
 *
...
if ( ! function_exists( 'xtrac_three_setup' ) ) :
	/**
	 ...
	 */
	function xtrac_three_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on xtrac-three, use a find and replace
		 * to change 'xtrac-three' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'xtrac-three', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'xtrac-three' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'xtrac_three_custom_background_args', array(
...
add_action( 'after_setup_theme', 'xtrac_three_setup' );
 ...
 */
function xtrac_three_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'xtrac_three_content_width', 640 );
}
add_action( 'after_setup_theme', 'xtrac_three_content_width', 0 );
 ...
 */
function xtrac_three_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'xtrac-three' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'xtrac-three' ),
...
add_action( 'widgets_init', 'xtrac_three_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function xtrac_three_scripts() {
	wp_enqueue_style( 'xtrac-three-style', get_stylesheet_uri() );

	wp_enqueue_script( 'xtrac-three-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'xtrac-three-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'PapaParse', get_template_directory_uri() . '/js/PapaParse-5.0.2/papaparse.min.js', array(), '5.0.2', true);

}
add_action( 'wp_enqueue_scripts', 'xtrac_three_scripts' );
